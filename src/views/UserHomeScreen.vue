        ...
        <v-card class="my-4" min-width="360">
          ...
          <v-card-text>
            ...
            <v-row class="justify-space-around">
              ...
              <v-col>
                <button @click="addToFav(album)">
                  <i :style="[album.isFavourite?{'color':'red'}:{}]" class="fa-solid fa-xl fa-heart"></i>
                </button>
              </v-col>
            </v-row>
          </v-card-text>
...
export default {
  ...
  methods: {
    ...
    addToFav(album){
      ...
      AlbumDataService.addToFavourite(album,userId).then(async res=>{
        var updatedAlbums = await this.getAllAlbums(userId);
